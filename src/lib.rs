...
use crate::dave_sequence_header::DaveSequenceHeader;

mod dave_sequence_header;

pub fn parse_hex_string(data: &str) -> Vec<u8> {
    data.split_whitespace()
        .map(|hex| u8::from_str_radix(&hex, 16).expect("Invalid hex input"))
        .collect::<Vec<u8>>()
}

pub fn parse_sequence_header(data: &str) -> Result<DaveSequenceHeader> {
    ...
    Ok(DaveSequenceHeader::from(out))
}
